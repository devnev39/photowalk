    ...
    <>
      ...
      <DialogContent>
        ...
        <TextField
          ...
          onChange={(event) =>
            setPlan((current) => {
              return { ...current, distance: event.target.value };
            })
          }
        />
        <TextField
          ...
          onChange={(event) =>
            setPlan((current) => {
              return { ...current, tag: event.target.value };
            })
          }
        />
        <TextField
          ...
          onChange={(event) =>
            setPlan((current) => {
              return { ...current, plan_datetime: event.target.value };
            })
          }
        />
        <FormControlLabel
          ...
          control={
            <Checkbox
              ...
              onChange={(event) =>
                setPlan((current) => {
                  return { ...current, is_open: event.target.checked };
                })
              }
            />
          }
      ...
      <DialogActions>
        ...
        <LoadingButton
          ...
          variant="outlined"
          onClick={planObj ? update : submit}
        >
          {planObj ? "Update" : "Submit"}
        </LoadingButton>
      </DialogActions>
    </>
  );
