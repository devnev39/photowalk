...
export default function AdminDialog({
  ...
  return (
    <>
      ...
      <DialogContent>
        <DialogContentText>
          After adding the user email and setting up the permission, the user
          can login and access the admin page with set restrictions !
        </DialogContentText>
        <TextField
          autoFocus
          error={user.email === ""}
        ...
        <FormControl fullWidth sx={{ my: 3 }}>
          ...
          <Select
            ...
            onChange={(event) =>
              setUser((current) => {
                return { ...current, role: event.target.value };
              })
            }
          >
        ...
        <FormControlLabel
          ...
          control={
            <Checkbox
              checked={user.can_createuser}
              onChange={(event) =>
                setUser((current) => {
                  return { ...current, can_createuser: event.target.checked };
                })
              }
            />
          }
        ...
        <FormControlLabel
          ...
          control={
            <Checkbox
              checked={user.can_createplan}
              onChange={(event) =>
                setUser((current) => {
                  return { ...current, can_createplan: event.target.checked };
                })
              }
            />
          }
        ...
        <FormControlLabel
          ...
          control={
            <Checkbox
              checked={user.can_updateplan}
              onChange={(event) =>
                setUser((current) => {
                  return { ...current, can_updateplan: event.target.checked };
                })
              }
            />
          }
      ...
      <DialogActions>
        ...
        <LoadingButton
          ...
          variant="outlined"
          onClick={userObj ? update : submit}
        >
          {userObj ? "Update" : "Submit"}
        </LoadingButton>
      </DialogActions>
    </>
  );
